...
python python/build_mandatory_matching.py --mandatory data/mandatory_clients_2025.csv --group-directory data/group_directory.csv --out templates/01_Group_Matching.csv --year 2025 --expected-count 96
...
python python/dependency_report.py --manifest config/internal_db_dependencies.json --env-file python/config.example.env --check
python python/db_connectors.py --env-file python/config.example.env --check
